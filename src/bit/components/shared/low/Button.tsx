...
const RenderedButton = styled.button.attrs<ButtonProps>(props => {
	if (props.disabled) {
		if (props.invert) {
			props.dark = '#666666'
			props.light = '#aaaaaa'
  ...
  &:hover {
    ${props => {
		...
		return `box-shadow: inset 0 0 100em 100em ${props.dark ? props.dark + '16' : props.theme.accent + '16'
			}`
	}}
  }
  ...
  &:active {
    ${props => {
		...
		return `box-shadow: inset 0 0 100em 100em ${props.dark ? props.dark + '32' : props.theme.accent + '32'
			}`
	}}
  }
`
