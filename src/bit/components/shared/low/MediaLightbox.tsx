...
const MediaLightbox = ({
	...
	const [mediaMaxWidth, setMediaMaxWidth] = useState(null as unknown as string)
	const [mediaAspectRatio, setMediaAspectRatio] = useState(null as unknown as number)
	...
	useEffect(() => {
		...
		if (type === TYPE_IMAGE) {
			if (!mediaMaxWidth) {
				...
				setMediaMaxWidth(mediaMaxWidth.toString())
			}
