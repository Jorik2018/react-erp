...
const NavBar = ({ meta, name, image }: { meta?:{teacherId:string,
	studentId:string,isStudent:string}, 
...
const mapStateToProps = (state: { account: { meta: string, user?: { name: string, image: string } } }) => {
	const {
		account: { meta, user }
	} = state
