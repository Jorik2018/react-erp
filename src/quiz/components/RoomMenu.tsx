...
import { QuestionType, QuizAppStates } from "../models/types";
...
type RoomMenuProps = {
  ...
  back: () => void,
  viewLeaderBoardCB: () => void,
  addQuestionCB: () => void,
  activateRoomCB: () => void,
  onSuccess?: (payload:{message:string,users:string[]}) => void,
...
class RoomMenu extends Component<RoomMenuProps, RoomMenuStates> {
  ...
  handleActivateResponse(payload:{message:string,users:string[]}) {
  ...
  handleDeleteResponse(payload: { message: string, questions: QuestionType[] }) {
    if (payload.message === "Success") {
      this.props.cb({
        questionList: payload.questions,
        // roomcode: this.props.roomcode,
    ...
    return (
      <div className="card">
        <div className="card-body">
          ...
          {error}
          <div className="alert alert-warning alert-dismissible"> roommenu-RoomCode: {this.props.roomcode}
